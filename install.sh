...
files="gitconfig config/qtile config/dunst config/termite config/rofi bashrc config/vifm/colors config/vifm/scripts config/vifm/vifmrc"           # list of files/folders to symlink in homedir
