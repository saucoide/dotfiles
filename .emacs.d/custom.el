...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dracula-theme yasnippet ranger range rustic mm-util evil-org-agenda doct elpher cider mu4e evil-snipe evil magit projectile counsel ivy all-the-icons eshell-toggle eglot git-gutter openwith all-the-icons-dired drag-stuff evil-org smartparens python-mode dired-hide-dotfiles dired-single company-box company evil-nerd-commenter typescript-mode lsp-mode visual-fill-column neotree treemacs-magit treemacs-icons-dired treemacs-projectile treemacs-evil treemacs magit-todos toc-org which-key use-package undo-fu smex rotate rainbow-delimiters org-bullets ivy-rich helpful general format-all flycheck evil-magit evil-collection doom-themes doom-modeline dashboard counsel-projectile)))
(custom-set-faces
